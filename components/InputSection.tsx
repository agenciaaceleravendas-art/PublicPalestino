  ...
  return (
    <div className="w-full max-w-3xl mx-auto mt-16 px-4">
      ...
      <form onSubmit={handleSubmit} className="relative">
        <div className="relative flex items-center bg-zinc-900/80 border border-white/5 rounded-2xl p-1.5 focus-within:border-indigo-500/50 transition-all shadow-[0_0_50px_-12px_rgba(0,0,0,0.5)] backdrop-blur-md">
          ...
          <input
            ...
            placeholder="Descreva a estrutura técnica (ex: Tenda Cristal 20x20m)..."
            className="flex-1 bg-transparent border-none outline-none text-white placeholder-zinc-700 px-5 py-4 text-base md:text-lg font-medium"
            disabled={isLoading}
          />
          <button
            type="submit"
            ...
            className={`
              flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl font-black text-[11px] uppercase tracking-[0.2em] transition-all duration-500
